...
export default function ExerciseCard(props) {
  ...
  return (
    <div className='flex flex-col gap-4 p-4 rounded-md bg-slate-950 sm:flex-wrap'>
        ...
        <h2 className='flex-1 max-w-full text-lg capitalize truncate sm:text-center sm:text-xl md:text-2xl whitespace-nowrap'>
        ...
        <div className="grid grid-cols-2 gap-2 sm:items-center sm:grid-cols-4">
